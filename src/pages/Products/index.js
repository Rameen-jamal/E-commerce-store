...
const TiltCard = ({ product }) => {
    ...
    const handleMouseMove = (e) => {
        ...
        card.style.boxShadow =
            `${-rotateY * 2}px ${rotateX * 2}px 40px rgba(79,70,229,0.18)`;
    };
        ...
        <PageTransition>
            <div className="productsPage">
                <div className="container">
                    ...
                    >
                        <h3 style={{ fontWeight: 800, fontSize: 28 }}>
                            {activeCategory === 'All'
                                ? 'All Products'
                                : activeCategory}
                        </h3>
